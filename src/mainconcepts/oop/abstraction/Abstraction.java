package mainconcepts.oop.abstraction;

// can't be instanciated
public abstract class Abstraction {
    public static String attributeOne = "attribute one";

    // mainconcepts.methods in abstract classes are considered in a static context, so they need to be static
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        // accessing static mainconcepts.methods in an abstract class
